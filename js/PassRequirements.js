...
//            defaults: true
        ...
        if(
            ...
            defaults.rules = $.extend({
                ...
                containSpecialChars: {
                    text: "must include at least minLength Special symbol",
                    minLength: 1,
                    regex: new RegExp('([^!,%,&,@,#,$,^,*,?,_,~])', 'g')
                },
                containLowercase: {
                    text: "must include at least minLength Lower Cased character",
                    minLength: 1,
                    regex: new RegExp('[^a-z]', 'g')
                },
                containUppercase: {
                    text: "must include at least minLength Upper Cased character",
                    minLength: 1,
                    regex: new RegExp('[^A-Z]', 'g')
                },
                containNumbers: {
                    text: "must include at least minLength number",
                    minLength: 1,
        ...
        return this.each(function () {
            ...
            $(this).popover({
                ...
                content: 'The recommended password should:<ul>' + requirementList + '</ul>'
